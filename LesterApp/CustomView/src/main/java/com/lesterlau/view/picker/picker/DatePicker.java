...
public class DatePicker extends WheelPicker {
    ...
    protected View makeCenterView() {
        ...
        int padding = dip2px(activity, 15);
        layout.setPadding(0, padding, 0, padding);
        layout.setGravity(Gravity.CENTER);

        //创建年滑动选区
        WheelView yearView = new WheelView(activity.getBaseContext());
        yearView.setLayoutParams(new LinearLayout.LayoutParams(dip2px(activity, 80), WRAP_CONTENT));
        ...
        monthView.setLayoutParams(new LinearLayout.LayoutParams(dip2px(activity, 80), WRAP_CONTENT));
        ...
        dayView.setLayoutParams(new LinearLayout.LayoutParams(dip2px(activity, 80), WRAP_CONTENT));
