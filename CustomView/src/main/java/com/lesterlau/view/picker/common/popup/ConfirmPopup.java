...
public abstract class ConfirmPopup<V extends View> extends BottomPopup<View> {
    ...
    protected final View makeContentView() {
        ...
        if (footerView != null) {
            ...
            footerLine.setBackgroundColor(Color.parseColor("#e5e5e5"));
    ...
    protected View makeHeaderView() {
        ...
        titleView.setLayoutParams(new ViewGroup.LayoutParams(MATCH_PARENT, dip2px(activity, 40)));
    ...
    protected View makeFooterView() {
        ...
        footerButtonLayout.setLayoutParams(new RelativeLayout.LayoutParams(MATCH_PARENT, dip2px(activity, 45)));
