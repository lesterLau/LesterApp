package com.lesterlau.view.picker.widget;
...
public class WheelView extends ScrollView {
     ...
     * 文字选中字体大小
     */
    public static final int TEXT_SELECTED_SIZE = 15;
    /**
     ...
     */
    public static final int TEXT_COLOR_NORMAL = 0XFFAAAAAA;
    /**
     * The constant LINE_COLOR.
     */
    public static final int LINE_COLOR = 0XFFFC615C;
    /**
    ...
    private int textSelectedSize = TEXT_SELECTED_SIZE;
    ...
    private void refreshItemView(int y) {
        ...
        for (int i = 0; i < childSize; i++) {
            ...
            if (position == i) {
                ...
                itemView.setTextSize(textSelectedSize);
            } else {
    ...
    private void onSelectedCallBack() {
        if (null != onWheelViewListener) {
            // 真实的index应该忽略偏移量
            onWheelViewListener.onSelected(isUserScroll, selectedIndex - offset,
                    selectedIndex >= items.size() ? "" : items.get(selectedIndex));
        }
    }
    ...
    public void setBackgroundDrawable(Drawable background) {
        ...
        if (null == paint) {
            ...
            paint.setStrokeWidth(1);//设置分割线的高度
        }
    ...
    private void setSelectedIndex(final int index) {
        this.postDelayed(new Runnable() {
            ...
            public void run() {
                ...
                // Log.d("selectedIndex==== ", index + ", " + itemHeight);
                //选中这一项的值
