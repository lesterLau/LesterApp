...
/**
 * 3D滚动控件（将自定义布局包含在StereoView中即可，使用参考y2_square_head）
 *
 * @Author lester
 * @Date 2018/7/30
 */
public class StereoView extends LinearLayout {
    ...
    private boolean is3DShow = false;//判断3D效果是否结束
