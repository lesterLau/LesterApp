...
public class TextureVideoView extends TextureView implements MediaPlayerControl {
    ...
    private void openVideo() {
        ...
        try {
            ...
            if (isKeepScreenOn) mMediaPlayer.setScreenOnWhilePlaying(true);
            if (isMute) mMediaPlayer.setVolume(0, 0);
    ...
    private boolean isMute = false;//if video play with mute
    private boolean isKeepScreenOn = false;//if keep screen on while playing

    /**
     * set mediaPlayer is mute.set after setVideoPath
     */
    ...
    /**
     * set keep screen on while playing
     */
    public void setPlayingScreenOn(boolean isKeepScreenOn) {
    ...
    private OnErrorListener mErrorListener =
            new OnErrorListener() {
                public boolean onError(MediaPlayer mp, int framework_err, int impl_err) {
                     ...
                     */
// we don't need type of this notification.just annotate it.2016-7.15
