...
public class NoScrollHorizontalListView extends HorizontalListView {
    ...
    public NoScrollHorizontalListView(Context context) {
        super(context);
    }

    public NoScrollHorizontalListView(Context context, AttributeSet attrs) {
        super(context, attrs);
    }

    public NoScrollHorizontalListView(Context context, AttributeSet attrs, int defStyle) {
