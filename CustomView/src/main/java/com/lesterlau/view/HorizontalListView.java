 ...
 *
 * @attr ref android.R.styleable#HorizontalListView_listSelector
 * @attr ref android.R.styleable#HorizontalListView_drawSelectorOnTop
 * @attr ref android.R.styleable#HorizontalListView_choiceMode
 * <p>
 * TODO divider, dividerWidth, headerDividersEnabled, footerDividersEnabled
 * @Author lester
 * @Date 2018/7/30
 */
public class HorizontalListView extends AdapterView<ListAdapter> implements
     ...
     *
     * @see HorizontalListView.RecycleBin
     * @see HorizontalListView#setRecyclerListener(HorizontalListView.RecyclerListener)
     */
    ...
    public HorizontalListView(Context context, AttributeSet attrs, int defStyle) {
        ...
        Drawable d = a.getDrawable(R.styleable.HorizontalListView_android_listSelector);
        if (d != null) {
            setSelector(d);
        }
        ...
        int choiceMode = a.getInt(R.styleable.HorizontalListView_android_choiceMode, -1);
        if (choiceMode >= 0) {
     ...
     *          in the recycler.
     * @see HorizontalListView.RecycleBin
     * @see HorizontalListView.RecyclerListener
     */
    ...
    public boolean showContextMenuForChild(View originalView) {
        ...
        if (longPressPosition >= 0) {
            ...
            if (listener != null) {
                handled = listener.onItemLongClick(HorizontalListView.this, originalView,
    ...
    private void useDefaultSelector() {
        setSelector(getResources().getDrawable(R.drawable.horizontal_listview_selector));
    }
    ...
    private boolean performLongPress(final View child,
        ...
        OnItemLongClickListener listener = getOnItemLongClickListener();
        if (listener != null) {
            handled = listener.onItemLongClick(HorizontalListView.this, child,
                    longPressPosition, longPressId);
        }
    ...
    private class AdapterDataSetObserver extends DataSetObserver {
        ...
        public void onChanged() {
            ...
            if (HorizontalListView.this.mHasStableIds && mInstanceState != null
                    && mOldItemCount == 0 && mItemCount > 0) {
                HorizontalListView.this.onRestoreInstanceState(mInstanceState);
                mInstanceState = null;
            } else {
                rememberSyncState();
            }
        ...
        public void onInvalidated() {
            ...
            if (HorizontalListView.this.mHasStableIds) {
                ...
                mInstanceState = HorizontalListView.this.onSaveInstanceState();
            }
    ...
    static class SavedState extends BaseSavedState {
        ...
        /**
         * Constructor called from {@link HorizontalListView#onSaveInstanceState()}
         */
    ...
    private static class ArrowScrollFocusResult {
        ...
        /**
         * How {@link HorizontalListView#arrowScrollFocused} returns its values.
         */
