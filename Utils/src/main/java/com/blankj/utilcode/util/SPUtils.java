...
public final class SPUtils {
    ...
    public static final String DEFALUT_SP_NAME = "spUtils";
    public static final String PUBLIC_SP_NAME = "PublicPreferencesUtils";
    public static final String TRADE_SP_NAME = "TradePwdPreferencesUtils";
